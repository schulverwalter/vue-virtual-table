...
<script>
import arrowCarrotDown from "./icons/arrowCarrotDown.vue";
import arrowCarrotRight from "./icons/arrowCarrotRight.vue";
import boxChecked from "./icons/boxChecked.vue";
